    ...
    return wrap(
      <>
        <div style={{ position:'absolute', left: 56, right: 56, top: 130, fontFamily: fonts.mono, fontSize: 15, color: pal.muted }}>
          &gt; init --module=pour_over --verbose<br/>
          &gt; loading assets... [████████] 100%<br/>
          &gt; ready.
        </div>
        <div style={{ position:'absolute', left: 56, right: 56, top: 320, fontFamily: fonts.display, fontSize: 240, lineHeight: 0.9, letterSpacing: '0.01em', color: pal.accent, textTransform: 'uppercase' }}>
          POUR_<br/>OVER.
        </div>
        <div style={{ position:'absolute', left: 56, right: 56, top: 860, fontFamily: fonts.mono, fontSize: 18, color: pal.ink, lineHeight: 1.5 }}>
          <span style={{ color: pal.accent }}>$</span> echo "{slide.subtitle}"
        </div>
        <div style={{ position:'absolute', left: 56, right: 56, top: 960, fontSize: 20, lineHeight: 1.5, fontFamily: fonts.mono, color: pal.ink, maxWidth: 900 }}>
          {slide.subtitle}
        </div>
      </>
    );
  ...
  if (slide.kind === 'stat') {
    return wrap(
      <>
        ...
        <div style={{ position:'absolute', left: 0, right: 0, top: 340, textAlign:'center', fontFamily: fonts.display, fontSize: 560, lineHeight: 0.88, color: pal.accent, textTransform: 'uppercase' }}>
          {slide.big}
        </div>
  ...
  if (slide.kind === 'cta') {
    return wrap(
      <>
        ...
        <div style={{ position:'absolute', left: 56, right: 56, top: 300, fontFamily: fonts.display, fontSize: 200, lineHeight: 0.9, textTransform: 'uppercase', color: pal.accent, letterSpacing: '0.01em' }}>
          SAVE_IT.<br/>
          <span style={{ color: pal.ink }}>FOLLOW_</span><br/>
          <span style={{ color: pal.ink }}>FOR_MORE.</span>
        </div>
