    ...
    return wrap(
      <>
        ...
        <div style={{ position: 'absolute', left: 56, right: 56, top: 240 }}>
          <h1 style={{
            fontFamily: fonts.display, fontWeight: 800, fontSize: 230, lineHeight: 0.82,
            letterSpacing: '-0.06em', margin: 0, textWrap: 'balance',
          }}>
            <span>pour-</span>
            <span style={{
  ...
  if (slide.kind === 'stat') {
    return wrap(
      <>
        ...
        <div style={{
          position: 'absolute', left: 0, right: 0, top: 260, textAlign:'center',
          fontFamily: fonts.display, fontWeight: 800, fontSize: 640, lineHeight: 0.84,
          letterSpacing: '-0.07em', color: pal.ink,
        }}>
    ...
    return wrap(
      <>
        <div style={{
          ...
          fontFamily: fonts.display, fontWeight: 800, fontSize: 280, lineHeight: 0.84,
          letterSpacing: '-0.06em', textTransform: 'uppercase',
        }}>
          <span>Follow</span><br/>
          <span style={{ WebkitTextStroke: `3px ${pal.accent}`, color: 'transparent' }}>& save</span><br/>
          <span style={{ color: pal.accent }}>/ / /</span>
        </div>
        <div style={{ position: 'absolute', left: 56, right: 56, bottom: 180 }}>
