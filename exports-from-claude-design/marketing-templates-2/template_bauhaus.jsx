  ...
  if (slide.kind === 'cover') {
    return wrap(
      <>
        ...
        <div style={{ position:'absolute', left: 56, right: 56, top: 560, fontFamily: fonts.display, fontWeight: 900, fontSize: 200, lineHeight: 0.86, letterSpacing: '-0.04em', textTransform: 'uppercase', textWrap:'balance' }}>
          <span style={{ color: pal.ink }}>Pour</span><br/>
          <span style={{ color: pal.accent }}>Over.</span>
        </div>
  ...
  if (slide.kind === 'stat') {
    return wrap(
      <>
        ...
        <div style={{ position:'absolute', left: 56, right: 56, top: 330, fontFamily: fonts.display, fontWeight: 900, fontSize: 560, lineHeight: 0.86, letterSpacing: '-0.06em' }}>
          {slide.big}
        </div>
  ...
  if (slide.kind === 'cta') {
    return wrap(
      <>
        ...
        <div style={{ position:'absolute', left: 56, right: 56, bottom: 340, fontFamily: fonts.display, fontWeight: 900, fontSize: 180, lineHeight: 0.9, letterSpacing: '-0.04em', textTransform: 'uppercase', textWrap:'balance' }}>
          Save. <span style={{ color: pal.accent }}>Follow.</span>
        </div>
