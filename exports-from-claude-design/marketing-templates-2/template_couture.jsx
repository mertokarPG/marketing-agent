    ...
    return wrap(
      <>
        ...
        <div style={{ position:'absolute', left: 0, right: 0, top: 320, textAlign:'center' }}>
          <div style={{ fontFamily: fonts.display, fontWeight: 300, fontSize: 270, lineHeight: 0.9, letterSpacing: '-0.02em', textWrap: 'balance', fontStyle:'italic', margin: 0 }}>
            Pour<br/>
            <span style={{ color: pal.accent, fontWeight: 400 }}>—</span><br/>
            over.
          </div>
        </div>
    ...
    return wrap(
      <>
        ...
        <div style={{ position:'absolute', left: 0, right: 0, top: 420, textAlign:'center' }}>
          <h2 style={{ fontFamily: fonts.display, fontStyle:'italic', fontWeight: 300, fontSize: 160, lineHeight: 1.0, margin: 0, letterSpacing: '-0.03em', textWrap:'balance', padding: '0 80px' }}>
            Un dimanche plus <span style={{ color: pal.accent }}>lent</span>.
          </h2>
        </div>
